<template>
  <div class="welcome-video-container">
    ...
    <div v-else class="welcome-video-placeholder">
      ...
      <p class="text-sm text-gray-600">No advanced welcome video available</p>
    </div>
    <button
...
const { markAdvancedWelcomeClicked } = useCourseAgreement()
...
const onContinue = async () => {
  ...
  isSaving.value = true
  try {
    await markAdvancedWelcomeClicked(user.id)
  } catch (e) {
    console.warn('Could not save advanced welcome clicked:', e)
  } finally {
