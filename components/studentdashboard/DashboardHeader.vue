    ...
    <transition name="fade">
      <div v-if="mobileMenuOpen" class="md:hidden bg-primary-600 border-t border-primary-700">
        <div class="px-4 py-4 space-y-3">
          <NuxtLink to="/dashboard" class="block text-white font-medium">Home</NuxtLink>
          <NuxtLink to="/dashboard/modules" class="block text-white font-medium">Modules</NuxtLink>
          <NuxtLink to="/dashboard/quizzes" class="block text-white font-medium">Quizzes</NuxtLink>
          <NuxtLink to="/dashboard/resources" class="block text-white font-medium">Resource Hub</NuxtLink>
        </div>
      </div>
    </transition>
  </header>
