  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-8">
      <div class="mb-6">
        ...
        <p class="text-gray-600 mt-2">Create and manage quizzes for your courses</p>
      </div>

      <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
        <p class="text-gray-600">Quiz management interface coming soon...</p>
      </div>
    </div>

    <!-- Footer -->
    <footer class="bg-primary-600 text-white text-center py-4 mt-8">
