        ...
        <aside class="xl:col-span-3 space-y-6">
          <div class="bg-white p-6 rounded-2xl shadow-sm text-center">
            ...
            <div class="relative inline-block">
              ...
              <!-- Upload overlay -->
              <label 
                :class="['absolute bottom-0 right-0 bg-primary-600 text-white p-2 rounded-full transition', uploading ? 'cursor-not-allowed opacity-75' : 'cursor-pointer hover:bg-primary-700']"
              >
                <input 
                  type="file" 
                  accept="image/*" 
                  ...
                  class="hidden"
                />
                <svg v-if="!uploading" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                  <path d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 animate-spin" fill="currentColor" viewBox="0 0 24 24">
