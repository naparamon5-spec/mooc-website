      ...
      <form @submit.prevent="onSubmit" class="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            class="mt-1 block w-full rounded-lg border border-sky-200 bg-white px-4 py-2 shadow-sm 
        ...
        <div>
          ...
          <div class="relative">
            <input
              ...
              class="mt-1 block w-full rounded-lg border border-sky-200 bg-white px-4 py-2 shadow-sm pr-12 
                     focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-400"
            />
              ...
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 
                         0-8.268-2.943-9.542-7a9.97 9.97 0 012.176-3.568M6.18 
                         6.18A9.953 9.953 0 0112 5c4.477 0 8.268 
                         2.943 9.542 7a9.98 9.98 0 01-4.043 5.19M6.18 
                         6.18L3 3m3.18 3.18L21 21" />
              </svg>
            </button>
          </div>
        </div>
        ...
        <button
          ...
          class="w-full inline-flex items-center justify-center gap-2 rounded-lg 
                 bg-gradient-to-r from-sky-600 to-indigo-600 text-white px-4 py-2 font-medium 
                 shadow hover:brightness-105 transition"
        >
